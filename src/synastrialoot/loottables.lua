			...
			["Instances"] = {
					...
					["Info"] = (function()
						...
						if not zoneName then
							DEFAULT_CHAT_FRAME:AddMessage(
								"|cff00ff00[SynastriaLoot]|r BabbleZone['Blackfathom Deeps'] is nil!"
							)
							...
							for k, v in pairs(BabbleZone or {}) do
								if count < 10 then
									DEFAULT_CHAT_FRAME:AddMessage(
										"|cff00ff00[SynastriaLoot]|r BabbleZone key: " .. tostring(k)
									)
									count = count + 1
								end
							end
				...
				["MythicBlackTemple"] = {
					...
					["Info"] = {
						BabbleZone["Black Temple"] .. "+",
						"SynastriaMythicBC",
						sortOrder = { "MythicBlackTempleStart", "MythicBlackTempleBasement", "MythicBlackTempleTop" },
						raid = true,
					},
					--["Info"] = { BabbleZone["Black Temple"] .. "+", "SynastriaMythicBC", sortOrder = { "MythicBlackTempleStart", "MythicBlackTempleBasement", "MythicBlackTempleTop" }, raid = true, mapname = "BlackTemple" },
				},
				...
				["MythicCoTHyjalEaI"] = {
					...
					["Info"] = {
						BabbleZone["Hyjal"] .. "+",
						"SynastriaMythicBC",
						sortOrder = { "MythicCoTHyjalEnt", "MythicCoTHyjal" },
						raid = true,
					},
					--["Info"] = { BabbleZone["Hyjal"] .. "+", "SynastriaMythicBC", sortOrder = { "MythicCoTHyjalEnt", "MythicCoTHyjal" }, raid = true, mapname = "CoTMountHyjal" },
				},
				...
				["MythicCFRSerpentshrineCavern"] = {
					...
					["Info"] = { BabbleZone["Serpentshrine Cavern"] .. "+", "SynastriaMythicBC", raid = true },
					--["Info"] = { BabbleZone["Serpentshrine Cavern"] .. "+", "SynastriaMythicBC", raid = true, mapname = "CoilfangReservoir" },
				},
				...
				["MythicGruulsLair"] = {
					...
					["Info"] = { BabbleZone["Gruul's Lair"] .. "+", "SynastriaMythicBC", raid = true },
					--["Info"] = { BabbleZone["Gruul's Lair"] .. "+", "SynastriaMythicBC", raid = true, mapname = "GruulsLair" },
				},
				...
				["MythicMagtheridonsLair"] = {
					...
					["Info"] = { BabbleZone["Magtheridon's Lair"] .. "+", "SynastriaMythicBC", raid = true },
					--["Info"] = { BabbleZone["Magtheridon's Lair"] .. "+", "SynastriaMythicBC", raid = true, mapname = "MagtheridonsLair" },
				},
				...
				["MythicKarazhanEaI"] = {
					...
					["Info"] = {
						BabbleZone["Karazhan"] .. "+",
						"SynastriaMythicBC",
						sortOrder = { "MythicKarazhanEnt", "MythicKarazhanStart", "MythicKarazhanEnd" },
						raid = true,
					},
					--["Info"] = { BabbleZone["Karazhan"] .. "+", "SynastriaMythicBC", sortOrder = { "MythicKarazhanEnt", "MythicKarazhanStart", "MythicKarazhanEnd" }, raid = true, mapname = "Karazhan" },
				},
				...
				["MythicSunwellPlateau"] = {
					...
					["Info"] = { BabbleZone["Sunwell Plateau"] .. "+", "SynastriaMythicBC", raid = true },
					--["Info"] = { BabbleZone["Sunwell Plateau"] .. "+", "SynastriaMythicBC", raid = true, mapname = "SunwellPlateau" },
				},
				...
				["MythicTempestKeepTheEye"] = {
					...
					["Info"] = { BabbleZone["The Eye"] .. "+", "SynastriaMythicBC", raid = true },
					--["Info"] = { BabbleZone["The Eye"] .. "+", "SynastriaMythicBC", raid = true, mapname = "TempestKeep" },
				},
				...
				["MythicZulAman"] = {
					...
					["Info"] = { BabbleZone["Zul'Aman"] .. "+", "SynastriaMythicBC", raid = true },
					--["Info"] = { BabbleZone["Zul'Aman"] .. "+", "SynastriaMythicBC", raid = true, mapname = "ZulAman" },
				},
