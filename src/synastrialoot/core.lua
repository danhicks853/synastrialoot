...
-- hashFactionItems[ITEMID] == 1 -- ALLIANCE
-- hashFactionItems[ITEMID] == 2 -- HORDE
local hashFactionItems = {
    -- Alliance Items
    [60] = 1,
    [61] = 1,
    [79] = 1,
...
local hashFactionItems = {
	...
	for _, itemID in ipairs(items) do
		-- Faction filter: Only show if not in table, or if matches player faction
		local lockedFaction = hashFactionItems[itemID]
